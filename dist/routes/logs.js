            ...
            switch (_e.label) {
                ...
                case 4:
                    ...
                    logs.map(function (e) {
                        if (!flat[e.sessionID])
                            flat[e.sessionID] = { logs: [] };
                        flat[e.sessionID] = __assign(__assign({}, flat[e.sessionID]), { logs: __spreadArray(__spreadArray([], flat[e.sessionID].logs, true), [
                                {
                                    fullName: e.fullName,
                                    distance: e.distance,
                                    date: e.date,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, hooks_1.dbQuery)("SELECT u.userID, l.distance, l.logID, s.sessionActive FROM logs l LEFT JOIN sessions s USING (sessionID) LEFT JOIN users u ON u.userID = l.userID WHERE l.logID = ?", [body["logID"]])];
                case 2:
                    results = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, hooks_1.dbQuery)("UPDATE logs SET distance=? WHERE logID=?", [
                            body["distance"],
                            body["logID"],
                        ])];
                case 3:
